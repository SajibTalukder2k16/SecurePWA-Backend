...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr 20 17:49:32 2025
...
# Parameters
num_devices = 20
num_unique_devices = 5
min_requests = 25
max_requests = 45
duplicate_ratio = 2.30  # 30% of the data will be duplicated



# Create dynamic paths
base_dir = f"Input/User_{num_devices}/Attack_Device_{num_unique_devices}"
csv_filename = os.path.join(base_dir, f"{num_devices}_{num_unique_devices}_{duplicate_ratio}.csv")
total_plot_path = os.path.join(base_dir, f"total_requests_{duplicate_ratio}.png")
device_plot_path = os.path.join(base_dir, f"device_distribution_plot_{duplicate_ratio}.png")
...
if __name__ == "__main__":
    ...
    print("\n--- Summary Report ---")
    print(f"Total requests (including duplicates): {total_requests}")
    ...
    print(f"Duplicated rows added: {num_duplicates}")
    ...
    # Plotting
    plot_data(df, total_plot_path, device_plot_path)
